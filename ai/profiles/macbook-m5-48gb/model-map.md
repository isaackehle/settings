...
| `qwen3.6-35b:opus4.7-128k` | `hf.co/hesamation/Qwen2.5-32B-Instruct-GGUF`                                           | `Qwen2.5-32B-Instruct.Q4_K_M.gguf`                                         | `Q4_K_M`     | `qwen2.5-32b-it-q4_k_m.gguf`                | `instruct-distill` |      `32768` | —               | PARAMETER temperature 0.5 |
...
| Tool           |    qwen3-coder-30b-a3b:q4    | qwen3.6-35b:opus4.7-128k | qwen3.5-27b:q4 |   qwen3.5:4b   | deepseek-r1:32b | qwen3:4b | codestral:22b | qwen2.5-coder:1.5b |  qwen2.5-coder:7b  | nomic-embed-text |
| -------------- | :--------------------------: | :----------------------: | :------------: | :------------: | :-------------: | :------: | :-----------: | :----------------: | :----------------: | :--------------: |
| **Cline**      |              —               |            —             |       —        |       —        |        —        |    —     |       —       |         —          |         —          |        —         |
| **ZooCode**    |              —               |            —             |       —        |       —        |        —        |    —     |       —       |         —          |         —          |        —         |
| **KiloCode**   |              —               |            —             |       —        |       —        |        —        |    —     |       —       |         —          |         —          |        —         |
