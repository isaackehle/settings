...
When you need to read files or search the codebase, call tools directly — do not narrate. Every response that involves reading must be one or more tool calls with NO content text. Do not say "I will" or "Let me" — just call the tool. When producing the plan, write it directly as prose.
