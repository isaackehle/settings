...
| `qwen3-coder-30b-a3b:q4`   | `hf.co/unsloth/Qwen3-Coder-30B-A3B-Instruct-GGUF`                     | `Qwen3-Coder-30B-A3B-Instruct-Q4_K_M.gguf`                       | `Q4_K_M`     | `qwen3-coder-30b-a3b-cd-q4_k_m.gguf`        | `coder`            |      `32768` | qwen3-coder-30b-a3b:q4-8k (8192), qwen3-coder-30b-a3b:q4-16k (16384), qwen3-coder-30b-a3b:q4-64k (65536), qwen3-coder-30b-a3b:q4-128k (131072), qwen3-coder-30b-a3b:q4-256k (262144) | PARAMETER temperature 0<br>PARAMETER repeat_penalty 1.05 |
...
| `qwen3.6-35b:opus4.7-128k` | `hf.co/hesamation/Qwen2.5-32B-Instruct-GGUF`                          | `Qwen2.5-32B-Instruct.Q4_K_M.gguf`                               | `Q4_K_M`     | `qwen2.5-32b-it-q4_k_m.gguf`                | `instruct-distill` |     `262144` | —                                                                                                                                                                                    | PARAMETER temperature 0.6                                |
...
flowchart LR
  ...
  local_codestral_22b_v0_1_cd_q4_k_m_gguf["Local GGUF: codestral-22b-v0.1-cd-q4_k_m.gguf"]:::file
  ollama_codestral_22b["Ollama: codestral:22b\nquant=Q4_K_M; family=coder"]:::ollama
  hf_hf_co_bartowski_Codestral_22B_v0_1_GGUF --> remote_hf_co_bartowski_Codestral_22B_v0_1_GGUF_Codestral_22B_v0_1_Q4_K_M_gguf --> local_codestral_22b_v0_1_cd_q4_k_m_gguf --> ollama_codestral_22b
  params_codestral_22b["MODELFILE params"]:::params
  params_codestral_22b -.-> ollama_codestral_22b
  ...
  hf_hf_co_unsloth_Qwen2_5_Coder_1_5B_Instruct_GGUF --> remote_hf_co_unsloth_Qwen2_5_Coder_1_5B_Instruct_GGUF_Qwen2_5_Coder_1_5B_Instruct_Q4_K_M_gguf --> local_qwen2_5_coder_1_5b_it_q4_k_m_gguf --> ollama_qwen2_5_coder_1_5b
  params_qwen2_5_coder_1_5b["MODELFILE params"]:::params
  params_qwen2_5_coder_1_5b -.-> ollama_qwen2_5_coder_1_5b
  ...
  local_qwen2_5_coder_7b_it_q4_k_m_gguf["Local GGUF: qwen2.5-coder-7b-it-q4_k_m.gguf"]:::file
  ollama_qwen2_5_coder_7b["Ollama: qwen2.5-coder:7b\nquant=Q4_K_M; family=coder"]:::ollama
  hf_hf_co_unsloth_Qwen2_5_Coder_7B_Instruct_GGUF --> remote_hf_co_unsloth_Qwen2_5_Coder_7B_Instruct_GGUF_Qwen2_5_Coder_7B_Instruct_Q4_K_M_gguf --> local_qwen2_5_coder_7b_it_q4_k_m_gguf --> ollama_qwen2_5_coder_7b
  params_qwen2_5_coder_7b["MODELFILE params"]:::params
  params_qwen2_5_coder_7b -.-> ollama_qwen2_5_coder_7b
  ctx_qwen2_5_coder_7b_8k["Ollama alias: qwen2.5-coder:7b-8k\nnum_ctx=8192"]:::ollama
  ollama_qwen2_5_coder_7b --> ctx_qwen2_5_coder_7b_8k
  ...
  remote_hf_co_unsloth_Qwen3_Coder_30B_A3B_Instruct_GGUF_Qwen3_Coder_30B_A3B_Instruct_Q4_K_M_gguf["Remote GGUF: Qwen3-Coder-30B-A3B-Instruct-Q4_K_M.gguf"]:::file
  local_qwen3_coder_30b_a3b_cd_q4_k_m_gguf["Local GGUF: qwen3-coder-30b-a3b-cd-q4_k_m.gguf"]:::file
  ollama_qwen3_coder_30b_a3b_q4["Ollama: qwen3-coder-30b-a3b:q4\nquant=Q4_K_M; family=coder"]:::ollama
  hf_hf_co_unsloth_Qwen3_Coder_30B_A3B_Instruct_GGUF --> remote_hf_co_unsloth_Qwen3_Coder_30B_A3B_Instruct_GGUF_Qwen3_Coder_30B_A3B_Instruct_Q4_K_M_gguf --> local_qwen3_coder_30b_a3b_cd_q4_k_m_gguf --> ollama_qwen3_coder_30b_a3b_q4
  params_qwen3_coder_30b_a3b_q4["MODELFILE params"]:::params
  params_qwen3_coder_30b_a3b_q4 -.-> ollama_qwen3_coder_30b_a3b_q4
  ctx_qwen3_coder_30b_a3b_q4_8k["Ollama alias: qwen3-coder-30b-a3b:q4-8k\nnum_ctx=8192"]:::ollama
  ollama_qwen3_coder_30b_a3b_q4 --> ctx_qwen3_coder_30b_a3b_q4_8k
  ctx_qwen3_coder_30b_a3b_q4_16k["Ollama alias: qwen3-coder-30b-a3b:q4-16k\nnum_ctx=16384"]:::ollama
  ollama_qwen3_coder_30b_a3b_q4 --> ctx_qwen3_coder_30b_a3b_q4_16k
  ctx_qwen3_coder_30b_a3b_q4_64k["Ollama alias: qwen3-coder-30b-a3b:q4-64k\nnum_ctx=65536"]:::ollama
  ollama_qwen3_coder_30b_a3b_q4 --> ctx_qwen3_coder_30b_a3b_q4_64k
  ctx_qwen3_coder_30b_a3b_q4_128k["Ollama alias: qwen3-coder-30b-a3b:q4-128k\nnum_ctx=131072"]:::ollama
  ollama_qwen3_coder_30b_a3b_q4 --> ctx_qwen3_coder_30b_a3b_q4_128k
  ctx_qwen3_coder_30b_a3b_q4_256k["Ollama alias: qwen3-coder-30b-a3b:q4-256k\nnum_ctx=262144"]:::ollama
  ollama_qwen3_coder_30b_a3b_q4 --> ctx_qwen3_coder_30b_a3b_q4_256k
  ...
  ctx_qwen3_4b_8k["Ollama alias: qwen3:4b-8k\nnum_ctx=8192"]:::ollama
  ollama_qwen3_4b --> ctx_qwen3_4b_8k
  ...
  ollama_qwen3_5_27b_q4 --> ctx_qwen3_5_27b_q4_8k
  ctx_qwen3_5_27b_q4_128k["Ollama alias: qwen3.5-27b:q4-128k\nnum_ctx=131072"]:::ollama
  ollama_qwen3_5_27b_q4 --> ctx_qwen3_5_27b_q4_128k
  ctx_qwen3_5_27b_q4_256k["Ollama alias: qwen3.5-27b:q4-256k\nnum_ctx=262144"]:::ollama
  ollama_qwen3_5_27b_q4 --> ctx_qwen3_5_27b_q4_256k
  ...
  hf_hf_co_hesamation_Qwen2_5_32B_Instruct_GGUF["HF: hf.co/hesamation/Qwen2.5-32B-Instruct-GGUF"]:::hf
  remote_hf_co_hesamation_Qwen2_5_32B_Instruct_GGUF_Qwen2_5_32B_Instruct_Q4_K_M_gguf["Remote GGUF: Qwen2.5-32B-Instruct.Q4_K_M.gguf"]:::file
  local_qwen2_5_32b_it_q4_k_m_gguf["Local GGUF: qwen2.5-32b-it-q4_k_m.gguf"]:::file
  ollama_qwen3_6_35b_opus4_7_128k["Ollama: qwen3.6-35b:opus4.7-128k\nquant=Q4_K_M; family=instruct-distill"]:::ollama
  hf_hf_co_hesamation_Qwen2_5_32B_Instruct_GGUF --> remote_hf_co_hesamation_Qwen2_5_32B_Instruct_GGUF_Qwen2_5_32B_Instruct_Q4_K_M_gguf --> local_qwen2_5_32b_it_q4_k_m_gguf --> ollama_qwen3_6_35b_opus4_7_128k
  params_qwen3_6_35b_opus4_7_128k["MODELFILE params"]:::params
  params_qwen3_6_35b_opus4_7_128k -.-> ollama_qwen3_6_35b_opus4_7_128k
```
...
| Tool           | qwen3-coder-30b-a3b:q4 | qwen3.6-35b:opus4.7-128k | qwen3.5-27b:q4  |   qwen3.5:4b   | deepseek-r1-tools:32b | qwen3:4b | codestral:22b | qwen2.5-coder:1.5b |  qwen2.5-coder:7b  | nomic-embed-text |
| -------------- | :--------------------: | :----------------------: | :-------------: | :------------: | :-------------------: | :------: | :-----------: | :----------------: | :----------------: | :--------------: |
| **Cline**      |           —            |            —             |        —        |       —        |           —           |    —     |       —       |         —          |         —          |        —         |
| **ZooCode**    |           —            |            —             |        —        |       —        |           —           |    —     |       —       |         —          |         —          |        —         |
| **KiloCode**   |           —            |            —             |        —        |       —        |           —           |    —     |       —       |         —          |         —          |        —         |
...
| Category           |   # | Models                                                   |
| ------------------ | --: | -------------------------------------------------------- |
| **Co-resident**    |   1 | `qwen3-coder-30b-a3b:q4` (26 GB)                         |
