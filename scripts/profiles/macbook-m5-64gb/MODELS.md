...
| GLM-4.7 Flash       | `glm-4.7-flash`       | `thudm/glm-4.7-flash`                   | ~5GB       | Fast, Chinese-optimized    |
| Llama 3.1 70B       | `llama3.1:70b`        | `meta-llama/llama-3.1-70b-instruct`     | ~40GB      | Larger reasoning           |
...
| ----------------- | -------------------------- | --------- | ------ |
| `llama3.1:70b`    | `MODELS/llama3.1-70b.mf`   | ~42GB     | ✅ Fits |
