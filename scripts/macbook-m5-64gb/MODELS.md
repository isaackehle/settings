...
| Property               | `qwen3.6-35b-a3b:q6`                            | `qwen3-4b-2507:q8`                                     | `qwen3.6-35b-32k:q6`   | `qwen3.6-35b-220k:q6`  | `qwen3-4b:q8`        | `deepseek-r1-tools:14b`               | `deepseek-r1-tools:32b`               | `qwen3-14b:q8`           | `qwen3-32b:q5`             | `qwen3.5:27b`    | `deepseek-r1:14b`    | `codestral:22b-v0.1-q8_0` | `qwen2.5-coder:7b`     | `qwen2.5-coder:1.5b` | `llama3.3:70b` | `nomic-embed-text` |
| ---------------------- | ----------------------------------------------- | ------------------------------------------------------ | ---------------------- | ---------------------- | -------------------- | ------------------------------------- | ------------------------------------- | ------------------------ | -------------------------- | ---------------- | -------------------- | ------------------------- | ---------------------- | -------------------- | -------------- | ------------------ |
| **Source**             | `hf.co/unsloth/Qwen3.6-35B-A3B-GGUF:UD-Q6_K_XL` | `hf.co/unsloth/Qwen3-4B-Instruct-2507-GGUF:UD-Q8_K_XL` | ← `qwen3.6-35b-a3b:q6` | ← `qwen3.6-35b-a3b:q6` | ← `qwen3-4b-2507:q8` | `mfdoom/deepseek-r1-tool-calling:14b` | `mfdoom/deepseek-r1-tool-calling:32b` | `dengcao/Qwen3-14B:Q8_0` | `dengcao/Qwen3-32B:Q5_K_M` | (direct pull)    | (direct pull)        | (direct pull)             | (direct pull)          | (direct pull)        | (direct pull)  | (direct pull)      |
...
| **LiteLLM model_name** | —                                               | —                                                      | `qwen3.6-35b-32k:q6`   | `qwen3.6-35b-220k:q6`  | `qwen3-4b:q8`        | `deepseek-r1-tools:14b`               | `deepseek-r1-tools:32b`               | `qwen3-14b:q8`           | `qwen3-32b:q5`             | `qwen3.5:27b`    | `deepseek-r1:14b`    | `codestral:22b-v0.1-q8_0` | `qwen2.5-coder:7b`     | `qwen2.5-coder:1.5b` | `llama3.3:70b` | `nomic-embed-text` |
...
```
hf.co/unsloth/Qwen3.6-35B-A3B-GGUF:UD-Q6_K_XL
...
| Tier             | Model                 | Notes                   |
| ---------------- | --------------------- | ----------------------- |
| Sonnet (default) | `qwen3.6-35b-32k:q6`  | 32k ctx, ~28 GB         |
| Haiku (fast)     | `qwen3-4b:q8`         | ~5 GB, planning/routing |
| Opus (large ctx) | `qwen3.6-35b-220k:q6` | 220k ctx — solo only    |
...
Primary model: `qwen3.6-35b-32k:q6`
...
| Agent      | Model                   | Purpose                            |
| ---------- | ----------------------- | ---------------------------------- |
| `code`     | `qwen3.6-35b-32k:q6`    | Implementation, editing, debugging |
