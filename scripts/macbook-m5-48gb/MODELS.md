...
| Property               | `qwen3.6-35b-a3b:q5`                            | `qwen3.6-35b-32k:q5`   | `qwen3.6-35b-220k:q5`  | `qwen3-4b-2507:q4`                                    | `qwen3-4b:q4`        | `deepseek-r1-tools:8b`               | `deepseek-r1:8b`     | `qwen3-14b:q5`             | `qwen3.5:27b`    | `codestral:22b`   | `qwen2.5-coder:7b` | `qwen2.5-coder:1.5b` | `nomic-embed-text` |
| ---------------------- | ----------------------------------------------- | ---------------------- | ---------------------- | ----------------------------------------------------- | -------------------- | ------------------------------------ | -------------------- | -------------------------- | ---------------- | ----------------- | ------------------ | -------------------- | ------------------ |
| **Source**             | `hf.co/unsloth/Qwen3.6-35B-A3B-GGUF:UD-Q5_K_XL` | ← `qwen3.6-35b-a3b:q5` | ← `qwen3.6-35b-a3b:q5` | `hf.co/unsloth/Qwen3-4B-Instruct-2507-GGUF:UD-Q4_K_M` | ← `qwen3-4b-2507:q4` | `mfdoom/deepseek-r1-tool-calling:8b` | (direct pull)        | `dengcao/Qwen3-14B:Q5_K_M` | (direct pull)    | (direct pull)     | (direct pull)      | (direct pull)        | (direct pull)      |
...
| **LiteLLM model_name** | —                                               | `qwen3.6-35b-32k:q5`   | `qwen3.6-35b-220k:q5`  | —                                                     | `qwen3-4b:q4`        | `deepseek-r1-tools:8b`               | `deepseek-r1:8b`     | `qwen3-14b:q5`             | `qwen3.5:27b`    | `codestral:22b`   | `qwen2.5-coder:7b` | `qwen2.5-coder:1.5b` | `nomic-embed-text` |
...
```
hf.co/unsloth/Qwen3.6-35B-A3B-GGUF:UD-Q5_K_XL
...
| Tier             | Model                 | Notes                   |
| ---------------- | --------------------- | ----------------------- |
| Sonnet (default) | `qwen3.6-35b-32k:q5`  | 32k ctx, ~25 GB         |
| Haiku (fast)     | `qwen3-4b:q4`         | ~3 GB, planning/routing |
| Opus (large ctx) | `qwen3.6-35b-220k:q5` | 220k ctx — solo only    |
...
| Role                    | Model                              |
| ----------------------- | ---------------------------------- |
| chat / edit / summarize | `qwen3.6-35b-32k:q5`               |
...
Primary model: `qwen3.6-35b-32k:q5`
...
- `gemini-3.1-pro-preview` → `qwen3.6-35b-32k:q5`

### Ollama convenience aliases `~/.ollama/config.json`

| Tag         | Model                  |
| ----------- | ---------------------- |
| `coding`    | `qwen3.6-35b-32k:q5`   |
| `primary`   | `qwen3.5:27b`          |
| `fast`      | `qwen3-4b:q4`          |
