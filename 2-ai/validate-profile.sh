...
#   2-ai/validate-profile.sh --strict
#   2-ai/validate-profile.sh --require-files
#   2-ai/validate-profile.sh --profile macbook-m5-64gb
#
# Exit codes:
#   0 = validation passed
#   1 = validation failed
...
usage() {
    cat <<'EOF'
Usage:
  2-ai/validate-profile.sh [--profile NAME] [--strict] [--require-files]
...
PROFILE_DIR="${SETTINGS_BASE}/2-ai/profiles/${PROFILE_NAME}"
