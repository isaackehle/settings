...
setup_openwebui() {
    ...
    log_info ""
    log_info "To connect to LiteLLM:"
    log_info "  1. Open http://localhost:${OPENWEBUI_PORT}"
    log_info "  2. Settings → Admin Settings → Connections"
    log_info "  3. Add API URL: http://host.docker.internal:4000/v1"
    log_info "  4. Add API Key: sk-local"
    log_info ""
    log_info "To connect to Ollama directly:"
