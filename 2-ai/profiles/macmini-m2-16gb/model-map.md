...
| `qwen2.5-coder:7b`   | `hf.co/Qwen/Qwen2.5-Coder-7B-Instruct-GGUF`                                            | `qwen2.5-coder-7b-instruct-q4_k_m.gguf`                                    | `Q4_K_M` | `qwen2.5-coder-7b-cd-q4_k_m.gguf`      | `coder`            |      `32768` | —               | PARAMETER temperature 0<br>PARAMETER repeat_penalty 1.05 |
