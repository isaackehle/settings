...
| `qwen3-coder-30b-a3b:q6`  | `hf.co/unsloth/Qwen3-Coder-30B-A3B-Instruct-GGUF`                                      | `Qwen3-Coder-30B-A3B-Instruct-UD-Q6_K_XL.gguf`                             | `UD-Q6_K_XL` | `qwen3-coder-30b-a3b-cd-ud-q6_k_xl.gguf`    | `coder`            |      `32768` | qwen3-coder-30b-a3b:q6-8k (8192), qwen3-coder-30b-a3b:q6-128k (131072), qwen3-coder-30b-a3b:q6-256k (262144)                                                                              | PARAMETER temperature 0<br>PARAMETER repeat_penalty 1.05 |
| `qwen3-coder-next-80b:q4` | `hf.co/unsloth/Qwen3-Coder-Next-GGUF`                                                  | `Qwen3-Coder-Next-Q4_K_M.gguf`                                             | `Q4_K_M`     | `qwen3-coder-next-80b-cd-q4_k_m.gguf`       | `coder`            |      `32768` | qwen3-coder-next-80b:q4-8k (8192), qwen3-coder-next-80b:q4-16k (16384), qwen3-coder-next-80b:q4-64k (65536), qwen3-coder-next-80b:q4-128k (131072), qwen3-coder-next-80b:q4-256k (262144) | PARAMETER temperature 0<br>PARAMETER repeat_penalty 1.05 |
...
| `qwen3.5:4b`              | `hf.co/unsloth/Qwen3.5-4B-GGUF`                                                        | `Qwen3.5-4B-Q4_K_M.gguf`                                                   | `Q4_K_M`     | `qwen3.5-4b-it-q4_k_m.gguf`                 | `instruct`         |     `131072` | —                                                                                                                                                                                         | PARAMETER temperature 0.2                                |
...
flowchart LR
  ...
  ollama_qwen3_coder_30b_a3b_q6["Ollama: qwen3-coder-30b-a3b:q6\nquant=UD-Q6_K_XL; family=coder"]:::ollama
  hf_hf_co_unsloth_Qwen3_Coder_30B_A3B_Instruct_GGUF --> remote_hf_co_unsloth_Qwen3_Coder_30B_A3B_Instruct_GGUF_Qwen3_Coder_30B_A3B_Instruct_UD_Q6_K_XL_gguf --> local_qwen3_coder_30b_a3b_cd_ud_q6_k_xl_gguf --> ollama_qwen3_coder_30b_a3b_q6
  params_qwen3_coder_30b_a3b_q6["MODELFILE params"]:::params
  params_qwen3_coder_30b_a3b_q6 -.-> ollama_qwen3_coder_30b_a3b_q6
  ctx_qwen3_coder_30b_a3b_q6_8k["Ollama alias: qwen3-coder-30b-a3b:q6-8k\nnum_ctx=8192"]:::ollama
  ollama_qwen3_coder_30b_a3b_q6 --> ctx_qwen3_coder_30b_a3b_q6_8k
  ctx_qwen3_coder_30b_a3b_q6_128k["Ollama alias: qwen3-coder-30b-a3b:q6-128k\nnum_ctx=131072"]:::ollama
  ollama_qwen3_coder_30b_a3b_q6 --> ctx_qwen3_coder_30b_a3b_q6_128k
  ctx_qwen3_coder_30b_a3b_q6_256k["Ollama alias: qwen3-coder-30b-a3b:q6-256k\nnum_ctx=262144"]:::ollama
  ollama_qwen3_coder_30b_a3b_q6 --> ctx_qwen3_coder_30b_a3b_q6_256k
  hf_hf_co_unsloth_Qwen3_Coder_Next_GGUF["HF: hf.co/unsloth/Qwen3-Coder-Next-GGUF"]:::hf
  remote_hf_co_unsloth_Qwen3_Coder_Next_GGUF_Qwen3_Coder_Next_Q4_K_M_gguf["Remote GGUF: Qwen3-Coder-Next-Q4_K_M.gguf"]:::file
  local_qwen3_coder_next_80b_cd_q4_k_m_gguf["Local GGUF: qwen3-coder-next-80b-cd-q4_k_m.gguf"]:::file
  ollama_qwen3_coder_next_80b_q4["Ollama: qwen3-coder-next-80b:q4\nquant=Q4_K_M; family=coder"]:::ollama
  hf_hf_co_unsloth_Qwen3_Coder_Next_GGUF --> remote_hf_co_unsloth_Qwen3_Coder_Next_GGUF_Qwen3_Coder_Next_Q4_K_M_gguf --> local_qwen3_coder_next_80b_cd_q4_k_m_gguf --> ollama_qwen3_coder_next_80b_q4
  params_qwen3_coder_next_80b_q4["MODELFILE params"]:::params
  params_qwen3_coder_next_80b_q4 -.-> ollama_qwen3_coder_next_80b_q4
  ctx_qwen3_coder_next_80b_q4_8k["Ollama alias: qwen3-coder-next-80b:q4-8k\nnum_ctx=8192"]:::ollama
  ollama_qwen3_coder_next_80b_q4 --> ctx_qwen3_coder_next_80b_q4_8k
  ctx_qwen3_coder_next_80b_q4_16k["Ollama alias: qwen3-coder-next-80b:q4-16k\nnum_ctx=16384"]:::ollama
  ollama_qwen3_coder_next_80b_q4 --> ctx_qwen3_coder_next_80b_q4_16k
  ctx_qwen3_coder_next_80b_q4_64k["Ollama alias: qwen3-coder-next-80b:q4-64k\nnum_ctx=65536"]:::ollama
  ollama_qwen3_coder_next_80b_q4 --> ctx_qwen3_coder_next_80b_q4_64k
  ctx_qwen3_coder_next_80b_q4_128k["Ollama alias: qwen3-coder-next-80b:q4-128k\nnum_ctx=131072"]:::ollama
  ollama_qwen3_coder_next_80b_q4 --> ctx_qwen3_coder_next_80b_q4_128k
  ctx_qwen3_coder_next_80b_q4_256k["Ollama alias: qwen3-coder-next-80b:q4-256k\nnum_ctx=262144"]:::ollama
  ollama_qwen3_coder_next_80b_q4 --> ctx_qwen3_coder_next_80b_q4_256k
  ...
  remote_hf_co_unsloth_Qwen3_5_4B_GGUF_Qwen3_5_4B_Q4_K_M_gguf["Remote GGUF: Qwen3.5-4B-Q4_K_M.gguf"]:::file
  local_qwen3_5_4b_it_q4_k_m_gguf["Local GGUF: qwen3.5-4b-it-q4_k_m.gguf"]:::file
  ollama_qwen3_5_4b["Ollama: qwen3.5:4b\nquant=Q4_K_M; family=instruct"]:::ollama
  hf_hf_co_unsloth_Qwen3_5_4B_GGUF --> remote_hf_co_unsloth_Qwen3_5_4B_GGUF_Qwen3_5_4B_Q4_K_M_gguf --> local_qwen3_5_4b_it_q4_k_m_gguf --> ollama_qwen3_5_4b
...
| Tool           | qwen3-coder-next-80b:q4 | qwen3-coder-30b-a3b:q6 | qwen3.6-35b:opus4.6 | gemma4:31b | qwen3.5-27b:q4 | qwen3.5-27b:q8 | deepseek-r1:32b | qwen3:4b | codestral:22b | qwen2.5-coder:1.5b |  qwen2.5-coder:7b  | nomic-embed-text |
| -------------- | :---------------------: | :--------------------: | :-----------------: | :--------: | :------------: | :------------: | :-------------: | :------: | :-----------: | :----------------: | :----------------: | :--------------: |
| **Cline**      |            —            |           —            |          —          |     —      |       —        |       —        |        —        |    —     |       —       |         —          |         —          |        —         |
| **ZooCode**    |            —            |           —            |          —          |     —      |       —        |       —        |        —        |    —     |       —       |         —          |         —          |        —         |
| **KiloCode**   |            —            |           —            |          —          |     —      |       —        |       —        |        —        |    —     |       —       |         —          |         —          |        —         |
...
| **Writing**        |   2 | `qwen3.5-27b:q4` (19 GB), `qwen3.5-27b:q8` (19 GB)       |
