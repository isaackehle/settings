...
| ---------- | ----------------------------------------- | ------------------------------------------------------------------ |
| 2026-05-27 | `2-ai/profiles/*/models.sh`               | All 5 profile model definitions audited against downstream configs |
| 2026-05-27 | `2-ai/profiles/*/opencode/opencode.jsonc` | OpenCode agent model assignments verified                          |
| 2026-05-27 | `2-ai/profiles/*/continue/config.yaml`    | Continue role assignments verified                                 |
| 2026-05-27 | `2-ai/profiles/*/ollama/config.json`      | Ollama model lists and aliases verified                            |
| 2026-05-27 | `2-ai/profiles/*/grok/grok.json`          | Grok CLI model lists verified                                      |
| 2026-05-27 | `2-ai/profiles/*/crush/crush.json`        | Crush model lists verified                                         |
| 2026-05-27 | `2-ai/profiles/*/gemini/settings.json`    | Gemini model lists verified                                        |
| 2026-05-27 | `2-ai/profiles/*/claude/settings.json`    | Claude Code model lists verified                                   |
| 2026-05-27 | `2-ai/profiles/*/cursor/settings.jsonc`   | Cursor model references verified                                   |
