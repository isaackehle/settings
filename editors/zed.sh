...
setup_zed() {
    ...
    local config_src="${SETTINGS_BASE}/ai/profiles/${MACHINE_PROFILE}/zed/settings.json"
    ...
    if [ -f "$config_src" ]; then
        ...
        log_warning "No profile config found — see ai/profiles/<machine>/zed/settings.json"
    fi
