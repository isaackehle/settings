...
setup_cursor() {
    ...
    local config_src="${SETTINGS_BASE}/ai/profiles/${MACHINE_PROFILE}/cursor/settings.jsonc"
    ...
    if [ -f "$config_src" ]; then
        ...
        log_warning "No profile config found — see ai/profiles/<machine>/cursor/settings.jsonc"
    fi
