...
Comprehensive reference for all AI tools in this setup. Install scripts live in category subdirectories under `ai/` (e.g., `runtimes/`, `agents/`, `editors/`) and are orchestrated by `setup-ai.sh` one level up. Machine-specific configs live in `ai/profiles/<machine>/<tool>/`.
...
- [ollama.com](https://ollama.com) · [docs](https://ollama.com/docs) · `ai/runtimes/ollama.sh`
...
- [omlx.ai](https://omlx.ai) · [github.com/jundot/omlx](https://github.com/jundot/omlx) · `ai/runtimes/omlx.sh`
...
bash ai/other/openwebui.sh setup
```
...
- [docs.openwebui.com](https://docs.openwebui.com) · `ai/other/openwebui.sh`
...
- [github.com/K2/olol](https://github.com/K2/olol) · `ai/other/olol.sh`
...
- [github.com/exo-explore/exo](https://github.com/exo-explore/exo) · `ai/other/exo.sh`
...
- [lmstudio.ai](https://lmstudio.ai) · [docs](https://docs.lmstudio.ai) · `ai/runtimes/lmstudio.sh`
...
- [nomic.ai/gpt4all](https://www.nomic.ai/gpt4all) · [github](https://github.com/nomic-ai/gpt4all) · `ai/runtimes/gpt4all.sh`
...
MACHINE_PROFILE=macbook-m5-64gb ai/runtimes/llama-cpp.sh serve heavy
MACHINE_PROFILE=macbook-m5-64gb ai/runtimes/llama-cpp.sh serve coder

# Inspect what would be served
MACHINE_PROFILE=macbook-m5-64gb ai/runtimes/llama-cpp.sh inspect heavy
```
...
- [github.com/ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) · `ai/runtimes/llama-cpp.sh`
...
- [vllm.ai](https://vllm.ai) · [docs](https://docs.vllm.ai) · `ai/runtimes/vllm.sh`
...
- [docs.anthropic.com/claude-code](https://docs.anthropic.com/en/docs/claude-code) · `ai/agents/claude.sh`
...
- [opencode.ai](https://opencode.ai) · `ai/agents/opencode.sh`
...
- [github.com/charmbracelet/crush](https://github.com/charmbracelet/crush) · `ai/agents/crush.sh`
...
- [aider.chat](https://aider.chat) · [config reference](https://aider.chat/docs/config/aider_conf.html) · `ai/agents/aider.sh`
...
- [github.com/google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) · `ai/agents/gemini.sh`
...
- [github.com/superagent-ai/grok-cli](https://github.com/superagent-ai/grok-cli) · `ai/agents/grok.sh`
...
- [openinterpreter.com](https://openinterpreter.com) · [docs](https://docs.openinterpreter.com) · `ai/agents/open-interpreter.sh`
...
# Setup: install CLI
bash ai/agents/open-hands.sh setup

# Start web UI on :3000
bash ai/agents/open-hands.sh start
```
...
- [docs.openhands.dev](https://docs.openhands.dev) · `ai/agents/open-hands.sh`
...
- [github.com/NVIDIA/OpenShell](https://github.com/NVIDIA/OpenShell) · `ai/agents/openshell.sh`
...
- [github.com/openai/codex](https://github.com/openai/codex) · `ai/agents/codex.sh`
...
- [code.visualstudio.com](https://code.visualstudio.com) · `ai/editors/vscode.sh`
...
- [cline.bot](https://cline.bot) · [github](https://github.com/cline/cline) · `ai/editors/cline.sh`
...
- [continue.dev](https://www.continue.dev) · [docs](https://docs.continue.dev) · `ai/editors/continue.sh`
...
- [github.com/features/copilot](https://github.com/features/copilot) · `ai/editors/github-copilot.sh`
...
- [kilocode.ai](https://kilocode.ai) · [docs](https://kilocode.ai/docs) · `ai/editors/kilocode.sh`
...
- [anythingllm.com](https://anythingllm.com) · [docs](https://docs.anythingllm.com) · `ai/other/anythingllm.sh`
...
- [tabby.tabbyml.com](https://tabby.tabbyml.com) · [docs](https://tabby.tabbyml.com/docs) · `ai/other/tabby.sh`
...
- [openrouter.ai](https://openrouter.ai) · [models](https://openrouter.ai/models) · `ai/cloud/openrouter.sh`
...
- [console.groq.com](https://console.groq.com) · [docs](https://console.groq.com/docs) · `ai/cloud/groq.sh`
...
- [docs.perplexity.ai](https://docs.perplexity.ai) · `ai/cloud/perplexity.sh`
...
- [huggingface.co](https://huggingface.co) · [CLI docs](https://huggingface.co/docs/huggingface_hub/guides/cli) · `ai/cloud/huggingface.sh`
...
- [github.com/AUTOMATIC1111](https://github.com/AUTOMATIC1111/stable-diffusion-webui) · `ai/image/automatic1111.sh`
...
- [drawthings.ai](https://drawthings.ai) · `ai/image/draw-things.sh`
...
- [langchain.com](https://www.langchain.com) · [docs](https://docs.langchain.com) · [github](https://github.com/langchain-ai/langchain) · `ai/frameworks/langchain.sh`
...
- [llamaindex.ai](https://www.llamaindex.ai) · [docs](https://docs.llamaindex.ai) · [github](https://github.com/run-llama/llama_index) · `ai/frameworks/llamaindex.sh`
...
- [pytorch.org](https://pytorch.org) · [MPS backend](https://pytorch.org/docs/stable/notes/mps.html) · `ai/frameworks/pytorch.sh`
