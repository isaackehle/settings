...
| GLM 5.1 | `glm-5.1:cloud` | `thudm/glm-5.1` | Reasoning, Chinese-optimized |
| deepseek-v4-flash:cloud | `deepseek-v4-flash:cloud` | `deepseek/deepseek-v4-flash` | High-throughput, cost-effective |
...
| LFM 2 24B | `lfm2:24b` | `lfm/lfm2-24b` | ~14GB | Trial local usage |

## Local Model Specs

| Ollama ID | Modelfile Path (Reference) |
|---|---|
| `llama3.1:70b` | `MODELS/llama3.1-70b.mf` |
| `gemma4:31b` | `MODELS/gemma4-31b.mf` |
| `qwen3.6:35b` | `MODELS/qwen3.6-35b.mf` |
| `codestral:22b` | `MODELS/codestral-22b.mf` |
| `deepseek-r1:14b` | `MODELS/ds-r1-14b.mf` |
| `phi4` | `MODELS/phi4.mf` |
